...
if !(call life_fnc_initMessageHUD) exitWith {};
...
life_message_list = [life_message_list, [_priority, _ctrlGroup], _insertIndex] call life_fnc_insertElement;
...
[_ctrlGroup controlsGroupCtrl 1001, _duration, _condition] spawn{
    ...
    // Remove message
    [ctrlParentControlsGroup _progress] call life_fnc_deleteMessage;
};
